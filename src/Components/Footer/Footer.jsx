...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded bg-bg-banner bg-cover bg-no-repeat w-full">
        ...
        <aside>
          <p>Copyright © 2023 - All right reserved by Bong Productions</p>
        </aside>
      </footer>
    </div>
  );
