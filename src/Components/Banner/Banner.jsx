...
const Banner = () => {
    return (
        <div >
            <div className=" bg-bg-banner h-[450px] bg-cover bg-no-repeat gradient-to-r from-cyan-500 to-blue-500 bg-blend-overlay ">
    ...
    className="relative bg-black/60 h-full "
      >
                   ...
                   <p className="pt-3 font-medium">Feel free to explore</p>
                   </div>
